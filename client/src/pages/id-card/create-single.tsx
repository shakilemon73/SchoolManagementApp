...
import { z } from 'zod';
import { Download, Upload, Eye, ArrowLeft, CreditCard, Calendar } from 'lucide-react';
...
export default function CreateSingleIdCard() {
    ...
    <AppShell>
      <div className="container mx-auto px-4 py-6 max-w-7xl">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900">একক আইডি কার্ড তৈরি</h1>
            <p className="text-gray-600 mt-1">একজন শিক্ষার্থীর জন্য আইডি কার্ড তৈরি করুন</p>
          </div>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                ...
                <Tabs defaultValue="student" className="w-full">
                  <TabsList className="grid w-full grid-cols-4">
                    ...
                    <TabsTrigger value="parent">অভিভাবক</TabsTrigger>
                    <TabsTrigger value="school">স্কুল</TabsTrigger>
                    <TabsTrigger value="validity">মেয়াদ</TabsTrigger>
                  </TabsList>
