...
// Schema for report template settings
...
export default function IncomeReportsMobilePage() {
  const { toast } = useToast();
    const [activeTab, setActiveTab] = useState("generate");
  const [isLoading, setIsLoading] = useState(false);
  const [previewMode, setPreviewMode] = useState(false);
  
  // Initial example income items
  const initialIncomeItems = [
    { category: "টিউশন ফি", description: "ক্লাস ৬-১০ জানুয়ারি মাসের টিউশন ফি", amount: "৩৫০,০০০", date: "২০২৫-০১-১০", reference: "INV-2025-01" },
    { category: "ভর্তি ফি", description: "নতুন ভর্তি ফি (২৫ জন)", amount: "১২৫,০০০", date: "২০২৫-০১-১৫", reference: "ADM-25" },
    { category: "পরীক্ষা ফি", description: "অর্ধ-বার্ষিক পরীক্ষা ফি", amount: "৮০,০০০", date: "২০২৫-০১-২০", reference: "EXAM-HY" },
    { category: "বই বিক্রয়", description: "সাপ্লিমেন্টারি বই বিক্রয়", amount: "৪৫,০০০", date: "২০২৫-০১-২৫", reference: "BK-150" },
    { category: "ডোনেশন", description: "অনুদান - পাঠাগার উন্নয়ন", amount: "১০০,০০০", date: "২০২৫-০১-৩০", reference: "DON-25-01" }
  ];
  ...
  return (
    <AppShell>
      <MobilePageLayout
        title="আয় রিপোর্ট"
        description="স্কুলের আয়ের বিস্তারিত রিপোর্ট তৈরি করুন"
        primaryAction={{
          icon: "description",
          label: "জেনারেট করুন",
            ...
            <div className="flex flex-col gap-4">
              <Card className="border-none shadow-sm overflow-hidden">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="text-base">
                    আয় রিপোর্টের জন্য প্রয়োজনীয় তথ্য প্রদান করুন
                  </CardDescription>
                </CardHeader>
                ...
                <CardContent>
                  <Form {...reportForm}>
                    <div className="space-y-1">
                      ...
                      {/* Income Items Preview */}
                      <FormSection 
                        title="আয় সমূহ" 
                        icon="payments"
                      >
                        <div className="border rounded-md p-3 bg-muted/10">
                          <h3 className="font-medium text-base">আয়ের সারসংক্ষেপ</h3>
                          <p className="text-sm text-muted-foreground mb-4">নিম্নে উল্লেখিত আয়ের উৎসসমূহ</p>
                          
                          <div className="space-y-2">
                            {(reportForm.getValues('incomeItems') || []).map((item, index) => (
                          ...
                          <div className="mt-4 pt-2 border-t flex justify-between">
                            <p className="font-semibold">মোট আয়:</p>
                            <p className="font-bold text-primary">৳ {calculateTotalIncome()}</p>
                          </div>
              ...
              <Card className="border-none shadow-sm overflow-hidden">
                <CardHeader className="pb-2">
                  ...
                  <CardDescription className="text-base">
                    আয় রিপোর্টের ফরম্যাট কাস্টমাইজ করুন
                  </CardDescription>
                </CardHeader>
            ...
            <div className="flex flex-col gap-4">
              <Card className="border shadow-md mb-4">
                ...
                <CardContent className="p-4">
                  <div id="income-report-preview" className="border p-4 bg-white rounded">
                    <div className="text-center mb-4">
                      <h2 className="text-xl font-bold">{reportForm.getValues('schoolNameInBangla')}</h2>
                      <p className="text-sm text-gray-600">{reportForm.getValues('schoolAddress')}</p>
                      <div className="mt-2 flex items-center justify-center">
                        <div className="h-px bg-gray-300 flex-1"></div>
                        <div className="px-4 text-lg font-bold text-primary">
                          {reportForm.getValues('reportTitleInBangla')}
                        </div>
                        <div className="h-px bg-gray-300 flex-1"></div>
                      </div>
                      <p className="text-sm mt-1">
                        সময়কাল: {reportForm.getValues('startDate')} থেকে {reportForm.getValues('endDate')}
                      </p>
                    </div>
                      ...
                      <table className="w-full border-collapse">
                        <thead>
                          <tr className="bg-primary/10">
                            ...
                            <th className="border p-2 text-center">রেফারেন্স</th>
                          </tr>
                        </thead>
                        <tbody>
                          {(reportForm.getValues('incomeItems') || []).map((item, index) => (
                            <tr key={index} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                              ...
                              <td className="border p-2 text-center">{item.reference}</td>
                            </tr>
                          ))}
                          <tr className="font-bold bg-gray-100">
                            <td className="border p-2" colSpan={2}>সর্বমোট</td>
                            <td className="border p-2 text-right">{calculateTotalIncome()}</td>
                    ...
                    <div className="mt-8 flex justify-between items-center">
                      <div className="text-center">
                        ...
                        <p className="text-sm">{reportForm.getValues('accountantName')}</p>
                        <p className="text-xs text-gray-600">হিসাব রক্ষক</p>
                      </div>
                      
                      <div className="text-center">
                        <div className="border-t border-gray-400 pt-1 w-32"></div>
                        <p className="text-sm">{reportForm.getValues('principalName')}</p>
            ...
            <div className="grid grid-cols-1 gap-3">
              <Card className="shadow-sm">
                <div className="flex p-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium">স্ট্যান্ডার্ড মাসিক রিপোর্ট</h3>
              ...
              <Card className="shadow-sm">
                <div className="flex p-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium">বার্ষিক আয় রিপোর্ট (গ্রাফিক্স সহ)</h3>
            ...
            <div className="grid grid-cols-1 gap-3">
              <Card className="shadow-sm">
                <div className="flex p-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium">জানুয়ারি ২০২৫ - মাসিক আয় রিপোর্ট</h3>
              ...
              <Card className="shadow-sm">
                <div className="flex p-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium">ডিসেম্বর ২০২৪ - মাসিক আয় রিপোর্ট</h3>
              ...
              <Card className="shadow-sm">
                <div className="flex p-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-medium">নভেম্বর ২০২৪ - মাসিক আয় রিপোর্ট</h3>
